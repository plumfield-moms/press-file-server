...
export function ProofColumns({proofs, setActive, stage}:{proofs: ProofArray, setActive: (proof_id: string)=>void, stage: string}){
    ...
    return <div className="w-full md:w-150 flex flex-col rounded-md  bg-primary text-background p-4 h-[90vh] overflow-y-auto scroll-fade scroll-fade-none">{Sections}</div>
